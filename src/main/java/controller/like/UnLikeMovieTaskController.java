...
@WebServlet("/detail/movie-unlike")
public class UnLikeMovieTaskController extends HttpServlet {
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 감독 좋아요 삭제
		int deleteLikeMovie = LikesDAO.deleteLikeMovie(movieId, logonUser.getId());
		if (deleteLikeMovie != 1) {
